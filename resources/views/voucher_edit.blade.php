           ...
           <?php $no = $key+1; ?>
            ...
            <tr  class="bg-light border-1 border-light" >
              ...
              <td>
               ...
               <td> <select name="SupplierID[]" id="SupplierID_{{$no}}" class="  form-select select2" onchange="ajax_balance(this.value);">
              ...
              <td> <select name="PartyID[]" id="PartyID_{{$no}}" class=" form-select select2" onchange="ajax_balance(this.value);">
                <option value="">Select Supplier</option>
              ...
              <td>
                <input type="number" name="Invoice[]" id="OPVAT_{{$no}}" class=" form-control  " autocomplete="off" value="{{$value1->InvoiceNo}}" >
              </td>
              <td>
              ...
              <td>
                <input type="number" name="Credit[]" id="credit_{{$no}}" class=" form-control changesNo totalLinePrice" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="{{$value1->Credit}}" >
              </td>
            </tr>
 <?php endforeach ?>
  ...
  <!--  <div class='row'>
    ...
    </div><div class="card-footer bg-light"> <div  ><button type="submit" id="submit" class="btn btn-primary w-lg me-50 float-right">Update</button>
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="ChOfAcc[]" id="ItemID0_'+i+'" class="form-select changesNoo">  <option value="">Select Account</option>@foreach ($chartofaccount as $key => $value) <option value="{{$value->ChartOfAccountID}}">{{$value->ChartOfAccountName}}</option>@endforeach</select> </td>';
