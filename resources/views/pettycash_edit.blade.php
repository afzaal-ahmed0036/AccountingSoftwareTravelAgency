...
<div class="clearfix mt-1"></div>
 ...
 >{{$value->ChartOfAccountName}}</option>
  ...
  <input type="text" name="Date"  autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="{{$pettycash_master[0]->Date}}">
          ...
          <tbody>
            ...
            <tr  class="bg-light border-1 border-light" >
              ...
              <td  >
                 ...
                 <select name="ChartOfAcc2[]" id="ItemID0_{{$no}}" class="form-select form-control-sm select2  ">
                  @foreach ($chartofaccount1 as $key => $value) 
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="ChartOfAcc2[]" id="ItemID0_'+i+'" class="form-select form-control-sm select2  ">@foreach ($chartofaccount1 as $key => $value)         <option value="{{$value->ChartOfAccountID}}">{{$value->ChartOfAccountName}}</option>  @endforeach       </select></td>';
