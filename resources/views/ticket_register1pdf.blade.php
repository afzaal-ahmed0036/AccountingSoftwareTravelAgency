  ...
  <thead style="display: table-header-group;">
   <tr>
     <th width="5%" bgcolor="#CCCCCC"><div align="center"><strong>DATE</strong></div></th>
      ...
      <th width="15%" bgcolor="#CCCCCC"><div align="left"><strong>A/LINE </strong></div></th>
      ...
      <th width="4%" bgcolor="#CCCCCC"><div align="right"><strong>FARE/RATE </strong></div></th>
      <th width="4%" bgcolor="#CCCCCC"><div align="right"><strong>TAXES </strong></div></th>
      <th width="4%" bgcolor="#CCCCCC"><div align="right"><strong>INCOME </strong></div></th>
      <th width="4%" bgcolor="#CCCCCC"><div align="right"><strong>AIRLINE </strong></div></th>
      <th width="4%" bgcolor="#CCCCCC"><div align="right"><strong>DISC </strong></div></th>
      <th width="4%" bgcolor="#CCCCCC"><div align="right"><strong>NET </strong></div></th>
      <th width="4%" bgcolor="#CCCCCC"><div align="right"><strong>PROFIT </strong></div></th>
   </tr>
  </thead>
  <tbody>
...
@endforeach
    <tr>
     <td width="5%" bgcolor="#CCCCCC"><div align="center"><strong></strong></div></td>
      ...
      <td width="5%" bgcolor="#CCCCCC"><div align="right"><strong>{{number_format($invoice_summary[0]->Fare,0)}} </strong></div></td>
      <td width="5%" bgcolor="#CCCCCC"><div align="right"><strong>{{number_format($invoice_summary[0]->Taxable,0)}} </strong></div></td>
      <td width="5%" bgcolor="#CCCCCC"><div align="right"><strong>{{number_format($invoice_summary[0]->Service,0)}} </strong></div></td>
      <td width="5%" bgcolor="#CCCCCC"><div align="right"><strong>{{number_format($invoice_summary[0]->Fare,0)}} </strong></div></td>
      <td width="5%" bgcolor="#CCCCCC"><div align="right"><strong>{{number_format($invoice_summary[0]->Discount,0)}} </strong></div></td>
      <td width="5%" bgcolor="#CCCCCC"><div align="right"><strong>{{number_format($invoice_summary[0]->Total,0)}} </strong></div></td>
      <td width="5%" bgcolor="#CCCCCC"><div align="right"><strong>{{number_format($invoice_summary[0]->Service,0)}} </strong></div></td>
   </tr>
