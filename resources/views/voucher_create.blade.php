                  ...
                  <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                    <table   style="border-collapse: collapse;" cellspacing="0" cellpadding="0">
                      ...
                      <tbody>
                        ...
                        <td> <select name="PartyID[]" id="PartyID_1" class="   form-select select2" onchange="ajax_balance(this.value);">
...
html += '<td><select name="ChOfAcc[]" id="ItemID0_'+i+'" class="form-select cls changesNoo select2"> <option value="">Select Account</option> @foreach ($chartofaccount as $key => $value) <option value="{{$value->ChartOfAccountID}}">{{$value->ChartOfAccountID}}-{{$value->ChartOfAccountName}}</option>@endforeach</select> </td>';
...
html += '<td><select name="PartyID[]" id="PartyID_'+i+'" class="form-select select2" onchange="ajax_balance(this.value);"><option value="">Select PartyID</option>@foreach ($party as $key => $value)<option value="{{$value->PartyID}}">{{$value->CategoryCode}}-{{$value->PartyName}}</option>@endforeach</select></td>';
