...
<div class="clearfix mt-1"></div>
        ...
        <div class='row'>
          ...
          <tbody>
            <tr  class="bg-light border-1 border-light" >
              ...
              <td> <select name="SupplierID[]" id="SupplierID_1" class="   form-select select2" onchange="ajax_balance(this.value);">
 ...
 <tr  class="bg-light border-1 border-light" >
              ...
              <td>
                 ...
                 <select name="ChOfAcc[]" id="ItemID0_2" class="select2 form-select form-control-sm   ">
                  <option value="">Select Account</option>
                  @foreach ($chartofaccount as $key => $value) 
                    <option value="{{$value->ChartOfAccountID}}">{{$value->ChartOfAccountID}}-{{$value->ChartOfAccountName}}</option>
                  @endforeach
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="ChOfAcc[]" id="ItemID0_'+i+'" class="form-select select2 changesNoo"> <option value="">Select Account</option> @foreach ($chartofaccount as $key => $value) <option value="{{$value->ChartOfAccountID}}">{{$value->ChartOfAccountID}}-{{$value->ChartOfAccountName}}</option>@endforeach</select> </td>';
