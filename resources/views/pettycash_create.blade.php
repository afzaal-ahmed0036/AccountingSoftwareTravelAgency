          ...
          <tbody>
            <tr  class="bg-light border-1 border-light" >
              ...
              <td style="width:300px;">
                 ...
                 <select name="ChartOfAcc2[]" id="ItemID0_1" class="form-select form-control-sm select2   " style="width:400px;">
...
$(".addmore").on('click',function(){
  ...
  html += '<td><select name="ChartOfAcc2[]" id="ItemID0_'+i+'" class="form-select form-control-sm  select2 " style="width:400px;">@foreach ($chartofaccount1 as $key => $value)         <option value="{{$value->ChartOfAccountID}}">{{$value->ChartOfAccountID}}-{{$value->ChartOfAccountName}}</option>  @endforeach       </select></td>';
