                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="SalemanID" id="SalemanID" class="form-select">
                                                ...
                                                <option value="{{ $value->SalemanID }}">{{ $value->SalemanName }}
                                                </option>
                                                <?php endforeach ?>
                                    ...
                                    <tr class="p-3">
                                        ...
                                        <td>
                                            ...
                                            <select name="ItemID0[]" id="ItemID0_1"
                                                class="form-select form-control-sm   changesNoo" required="">
                                        ...
                                        <td> <select name="SupplierID[]" id="SupplierID_1"
                                        ...
                                        <td>
                                            <input type="text" name="RefNo[]" id="RefNo_1"
                                                ...
                                                onchange="ajax_ticket(this.value);">
                                        </td>

                                        <td>
                                            <input type="text" name="VisaType[]" id="VisaType_1"
                                                class="   form-control  " autocomplete="off">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="PNR[]" id="PNR_1"
                                                class=" form-control  " autocomplete="off">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="number" name="TaxAmount[]" id="quantity_1"
                                                class=" form-control  " autocomplete="off"
                                                onkeypress="return IsNumeric(event);" ondrop="return false;"
                                                onpaste="return false;" step="0.01">
                                        </td>
    ...
    <script>
        ...
        $(".addmore").on('click', function() {
            ...
            html += '<td><select name="ItemID0[]" id="ItemID0_' + i +
                '" class="form-select changesNoo" required=""> @foreach ($items as $key => $value) <option value="">Select</option><option value="{{ $value->ItemID }}|{{ $value->Percentage }}">{{ $value->ItemCode }}-{{ $value->ItemName }}-{{ $value->Percentage }}</option>@endforeach</select><input type="hidden" name="ItemID[]" id="ItemID_' +
                i + '"></td>';
            ...
            html += '<td><select name="SupplierID[]" id="SupplierID_' + i +
                '"  onchange="ajax_balance(this.value);" class=" form-select select2 cls">@foreach ($party as $key => $value) <option value="{{ $value->PartyID }}">{{ $value->PartyName }}</option>@endforeach</select></td>';
            html += '<td><input type="text" name="RefNo[]" id="RefNo_' + i +
                '" class="form-control  " onchange="ajax_ticket(this.value);"  ></td>';
        ...
        $(document).on('change keyup blur', '.changesNo', function() {
            ...
            if (Fare != '' && Service != '')
                $('#total_' + id[1]).val((parseFloat(Fare) + parseFloat(Service) + parseFloat(OPVAT) + parseFloat(
                    IPVAT) + parseFloat(Tax) - parseFloat(Discount)).toFixed(2));
